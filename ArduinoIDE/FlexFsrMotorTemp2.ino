...
int TempPin2 =A5; 
int inputValue2 = 0; // integer value from ADC
float inputVoltage2 = 0; //float value of voltage measured
float tempmath11 = 0;    // float value for tempmath1
float tempmath22 = 0;    // float value for tempmath2
...
void loop() {
  ...
  // temp maths2
  inputValue2 = analogRead(TempPin2); // reads value from analogue pin A7
  inputVoltage2 = inputValue2 * 5.0/1024; // converts raw reading to voltage
  tempmath11 = inputVoltage2 / -0.0522;  
  tempmath22 = tempmath11 +118.5;
